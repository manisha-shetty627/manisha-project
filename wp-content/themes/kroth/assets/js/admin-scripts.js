/*
 * All Admin Related Scripts in this Kroth Theme
...
jQuery(document).ready(function($) {
  ...
  /*---------------------------------------------------------------*/
  function kroth_toggle_metaboxes() {

    // Hide All Format Metabox Fields
    function hide_all_format_metaboxes() {
      $('#cs-tab-section_post_formats .cs-element-standard-image, #cs-tab-section_post_formats .cs-element-gallery-format, #cs-tab-section_post_formats .cs-element-add-gallery').hide();
    }
    // Show Only Gallery Format Metabox Fields
    function gallery_format_metaboxes() {
      $('#cs-tab-section_post_formats .cs-element-standard-image').slideUp('fast');
      $('#cs-tab-section_post_formats .cs-element-add-gallery, #cs-tab-section_post_formats .cs-element-gallery-format').slideDown('slow');
    }
    // Show Only Image Format Metabox Fields
    function image_format_metaboxes() {
      $('#cs-tab-section_post_formats .cs-element-gallery-format, #cs-tab-section_post_formats .cs-element-add-gallery').slideUp('fast');
      $('#cs-tab-section_post_formats .cs-element-standard-image').slideDown('slow');
    }
  ...
  kroth_toggle_metaboxes(); // Execute on document ready

  if (!$('body').hasClass('.block-editor-page')) {
    $('#post-formats-select input[type="radio"]').click(kroth_toggle_metaboxes);
  }
