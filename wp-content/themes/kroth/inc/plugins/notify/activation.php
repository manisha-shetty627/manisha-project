 ...
 */
require_once KROTH_FRAMEWORK . '/plugins/notify/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'kroth_register_required_plugins' );
 ...
 */
function kroth_register_required_plugins() {
	/*
    ...
    array(
	    'name'					=> 'Kroth Core',
	    'slug'     			=> 'kroth-core',
	    'source'				=> 'http://victorthemes.com/plugins/kroth-core.zip',
	    'required'			=> true,
