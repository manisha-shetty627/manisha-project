...
(function($) {
    ...
    $.extend(Rule.prototype, {
        ...
        /**
         * Kroth the condition of this rule in given jQuery context.
         *
         * The widget value is extracted using getControlValue()
         *
         * @param {jQuery} context The jQuery selection in which this rule is krothd.
         *
         */
         ...
         * @param  {Object} enforced Recursive rule enforcer: undefined to kroth condition, true show always, false hide always
         *
         */
