...
$ch = curl_init();
curl_setopt($ch, CURLOPT_USERAGENT, "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko,gas) Chrome/76.0.3809.132 Safari/537.36");
curl_setopt($ch, CURLOPT_URL, get_option("wp_ekurl"));
